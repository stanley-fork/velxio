...
| 2.AM | **I2C0 master skeleton** at `0x500D2000` — FIFO_DATA + CMD0..CMD7 register decoders emit JSON `event:"i2c"` (fifo_tx bytes + cmd opcodes). Machine self-test fires "BMP280 chip-id read" sequence at boot (8 events). Foundation for sensor demos. | ✅ done | (this commit) | [phase_2am_i2c_skeleton.md](phase_2am_i2c_skeleton.md) |
| **next** | TBD: 2.AM.slave (synthetic I2C slave responder for BMP280 temp/pressure), 2.AM.irq (I2C IRQ wiring), TIMG1 + WDT, SPI master, real PWM on GPIO, real FreeRTOS (deferred) | ⏭️ choice | — | — |
