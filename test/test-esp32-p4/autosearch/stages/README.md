...
| 2.AF | **LEDC 3-channel RGB rainbow**: demo blob now drives CH0/CH1/CH2 simultaneously. CH2 = `(sample + 0x555) & 0x7FF` — 240° phase-shifted. Validates LEDC decode for channels beyond 1; gives frontend a 3-LED chase pattern. | ✅ done | (this commit) | [phase_2af_ledc_rgb_rainbow.md](phase_2af_ledc_rgb_rainbow.md) |
| **next** | TBD: TIMG (delay/millis foundation), I2C master, SPI master, real PWM waveform on GPIO, LEVEL_HIGH/LOW GPIO IRQ types, or real FreeRTOS port (Phase 2.V deferred) | ⏭️ choice | — | — |
