...
| 2.AE | **LEDC multi-channel crossfade**: demo blob extended to also drive CH1 = `(0x7FF - sample)` for inverse fade. Pairs of CH0+CH1 events with sums always = 0x7FF prove multi-channel decode works. | ✅ done | (this commit) | [phase_2ae_ledc_multichannel.md](phase_2ae_ledc_multichannel.md) |
| **next** | TBD: I2C master, SPI master, real PWM waveform, TIMG (delay/millis), LEVEL_HIGH/LOW GPIO, or real FreeRTOS port (Phase 2.V deferred) | ⏭️ choice | — | — |
