...
| 2.AS | **Peripheral relocation to real-silicon addresses**. TIMG0 0x500BC000→0x500C2000, TIMG1 0x500C0000→0x500C3000, I2C0 0x500D2000→0x500C4000, SPI2 0x500CC000→0x500D0000 (per IDF reg_base.h). Bumped TIMG overlay priority 1→3 to override smart_stubs. Added rtc_clk_cal_done bit override at TIMG offset 0x80 (was provided by smart_stub). Updated demo blob ISR `lui` for new TIMG bases. All Phase 2.AR functionality preserved at silicon-correct addresses. | ✅ done | (this commit) | [phase_2as_relocate.md](phase_2as_relocate.md) |
| **next** | TBD: 2.AP.reset (WDT actual reset), RTC WDT, Super WDT, 2.AO.slave (ILI9341 responder), UART RX, real PWM, FreeRTOS (deferred) | ⏭️ choice | — | — |
