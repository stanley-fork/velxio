...
export const ONLINE_ONLY_BOARD_ADS: OnlineOnlyBoardAd[] = [
  {
    ...
    label: 'ESP32-S3-EYE',
    description:
      'Espressif AI vision kit: ESP32-S3, OV2640 camera, 1.3" 240x240 LCD, I2S mic, accelerometer — in-browser emulation',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'Espressif knob kit: round GC9A01 display on a rotary encoder, WS2812, IR, PDM speaker — in-browser emulation',
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">' +
  ...
  },
  {
    ...
    label: 'ESP-VoCat',
    description:
      'Espressif AI voice devkit: ESP32-S3, ST77916 1.8" touch LCD, dual mic + speaker, IMU — in-browser emulation',
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">' +
  ...
  },
  {
    ...
    description:
      'Espressif flagship RISC-V: dual-core 400MHz, MIPI-DSI display, MIPI-CSI camera, WiFi via ESP32-C6 — in-browser emulation',
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">' +
  ...
  },
  {
    ...
    description:
      'Bare ESP32-P4 DevKit: dual-core RISC-V 400MHz, 32MB PSRAM, every GPIO broken out for your own circuits — in-browser emulation',
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">' +
  ...
  },
  {
    ...
    description:
      'Espressif ESP32-C5 sensing devkit: BME690 gas sensor + BMM350 magnetometer shuttles, 1.9" touch LCD, WiFi 6 dual-band — in-browser emulation',
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">' +
    ...
    thumbnailSvg:
      ...
      Array.from({ length: 3 }, (_, r) =>
        Array.from(
          { length: 12 },
          (_, c) =>
            `<rect x="${11 + c * 4.2}" y="${40 + r * 5.5}" width="3.4" height="4.4" rx="0.8"/>`,
        ).join(''),
      ).join('') +
      '</g></svg>',
  },
  {
    ...
    thumbnailSvg:
      ...
      Array.from(
        { length: 8 },
        (_, i) => `<rect x="23" y="${8 + i * 7}" width="3" height="3"/>`,
      ).join('') +
      Array.from(
        { length: 8 },
        (_, i) => `<rect x="46" y="${8 + i * 7}" width="3" height="3"/>`,
      ).join('') +
      '</g></svg>',
  },
  {
  ...
  },
  {
    ...
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg"><rect x="18" y="8" width="36" height="56" rx="7" fill="#17181c" stroke="#4a7dbd" stroke-width="1.6"/><rect x="28" y="5" width="16" height="8" rx="2" fill="#b9bec7"/><rect x="27" y="26" width="18" height="14" rx="2" fill="#b9bec7"/><g fill="#d8b23a"><circle cx="20" cy="20" r="2"/><circle cx="20" cy="28" r="2"/><circle cx="20" cy="36" r="2"/><circle cx="20" cy="44" r="2"/><circle cx="20" cy="52" r="2"/><circle cx="52" cy="20" r="2"/><circle cx="52" cy="28" r="2"/><circle cx="52" cy="36" r="2"/><circle cx="52" cy="44" r="2"/><circle cx="52" cy="52" r="2"/></g><text x="36" y="59" text-anchor="middle" font-size="6" font-family="monospace" fill="#e8e8ec">RP</text></svg>',
  },
  {
    id: 'unihiker-m10',
    label: 'UNIHIKER M10',
    description:
      'DFRobot IoT SBC: RK3308 Linux + 2.8" touchscreen (micro:bit edge) - available in the online editor',
    thumbnailSvg:
      '<svg width="72" height="72" viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">' +
...
export const ONLINE_ONLY_COMPONENT_ADS: OnlineOnlyComponentAd[] = [
  {
    ...
    description:
      'Sensirion photoacoustic CO2 (400-5000 ppm) with temperature and humidity over I2C, live sliders while it runs - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
      "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 60'><rect x='12' y='12' width='36' height='36' rx='4' fill='#12463a' stroke='#0b3129' stroke-width='1'/><rect x='18' y='20' width='24' height='16' rx='2' fill='#b9c2bd'/><text x='30' y='45' font-family='monospace' font-size='7' fill='#eaf3ea' text-anchor='middle'>SCD41</text></svg>",
  },
  {
    id: 'pro-bme688',
    label: 'BME688 Gas Sensor',
    description:
      'Bosch temperature, humidity, pressure and a heated gas plate, driven the way the Bosch API drives it - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
      "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 60'><rect x='14' y='14' width='32' height='32' rx='3' fill='#5c3a12' stroke='#3f280c' stroke-width='1'/><rect x='23' y='22' width='14' height='14' rx='2' fill='#cfd3d9'/><text x='30' y='44' font-family='monospace' font-size='6' fill='#f2ece0' text-anchor='middle'>BME688</text></svg>",
  },
  {
    id: 'pro-bme280',
    label: 'BME280 Sensor',
    description:
      'Bosch temperature, humidity and pressure over I2C, with live sliders for all three readings - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
      "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 60'><rect x='15' y='15' width='30' height='30' rx='3' fill='#1a1a1a' stroke='#555' stroke-width='1'/><text x='30' y='34' font-family='monospace' font-size='8' fill='#4fc3f7' text-anchor='middle'>BME280</text></svg>",
  },
  {
    id: 'pro-encoder-wheel',
    label: 'RGB Encoder Wheel',
    description:
      "Pimoroni's rotary wheel: 24 RGB LEDs, five switches, an IO expander and an IS31FL3731 modelled at register level - available in the online editor",
    category: 'input',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      '1-Wire digital thermometer, -55 to +125 C. The BUS is modelled too, so several share one pin and DallasTemperature discovers every one - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
      "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 60'><path d='M14 12 L14 22' stroke='#b9c0c6' stroke-width='2.4' stroke-linecap='round'/><path d='M30 12 L30 22' stroke='#b9c0c6' stroke-width='2.4' stroke-linecap='round'/><path d='M46 12 L46 22' stroke='#b9c0c6' stroke-width='2.4' stroke-linecap='round'/><circle cx='14' cy='12' r='3.4' fill='#c9a23a'/><circle cx='30' cy='12' r='3.4' fill='#c9a23a'/><circle cx='46' cy='12' r='3.4' fill='#c9a23a'/><path d='M12 50 L12 32 A18 18 0 0 1 48 32 L48 50 Z' fill='#1c1c1e' stroke='#0a0a0b' stroke-width='1.2'/><path d='M12 50 L12 34 A16 16 0 0 1 28 25 L28 50 Z' fill='#242427'/><text x='30' y='44' font-family='monospace' font-size='8' font-weight='600' fill='#e6e6e6' text-anchor='middle'>18B20</text></svg>",
  },
  {
    id: 'pro-max6675',
    label: 'MAX6675 K-Type Thermocouple',
    description:
      'K-type thermocouple up to 1024 C over SPI, the range an NTC cannot reach - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'Every thermocouple type, B included: 1000-1800 C over SPI, cold-junction compensated - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'The other lab standard: PT100 RTD over SPI, 2/3/4-wire - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'Eight 10-bit analog inputs over SPI, the analog input a Raspberry Pi does not have - available in the online editor',
    category: 'analog',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'The Pi camera on its ribbon, with picamera2 and OpenCV in the browser - available in the online editor',
    category: 'sensors',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'A 320x240 ILI9341 panel with an XPT2046 resistive touch screen on the same SPI bus - available in the online editor',
    category: 'displays',
    thumbnailSvg:
  ...
  {
    id: 'pro-ili9488',
    label: '3.5" TFT 480x320 + Touch (ILI9488 + XPT2046)',
    description:
      'A 480x320 ILI9488 panel in 18-bit colour with an XPT2046 resistive touch screen on the same SPI bus - available in the online editor',
    category: 'displays',
    thumbnailSvg:
      "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 60'><rect x='8' y='2' width='44' height='56' rx='3' fill='#16233a' stroke='#0b1424' stroke-width='1'/><rect x='12' y='9' width='36' height='44' rx='1.5' fill='#05070c' stroke='#243349' stroke-width='1'/><rect x='14' y='11' width='32' height='40' fill='#0c1a2a'/><rect x='16' y='14' width='4' height='10' fill='#ff3b30'/><rect x='21' y='14' width='4' height='10' fill='#ffc800'/><rect x='26' y='14' width='4' height='10' fill='#00dc50'/><rect x='31' y='14' width='4' height='10' fill='#00c8ff'/><rect x='36' y='14' width='4' height='10' fill='#2850ff'/><rect x='41' y='14' width='3' height='10' fill='#e600c8'/><rect x='16' y='30' width='24' height='4' rx='2' fill='#dfe6f0'/><rect x='16' y='38' width='16' height='3' rx='1.5' fill='#394a5e'/></svg>",
  },
  {
    id: 'pro-dc-motor',
    label: 'DC Motor / Fan',
    description:
      'A brushed motor that spins as fast as the PWM lets it, with inertia and a stall current - available in the online editor',
    category: 'motors',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'A gear motor whose Hall encoder really counts: A and B land on the board clock, so a PID can hold a speed - available in the online editor',
    category: 'motors',
    thumbnailSvg:
  ...
  },
  {
    ...
    label: 'Heater Block',
    description:
      'A heater with real thermal mass: it warms what is around it and cools to ambient when you cut the power - available in the online editor',
    category: 'output',
    thumbnailSvg:
  ...
  },
  {
    ...
    description:
      'Zero-cross solid-state relay: a logic pin switches the load, the way a real oven or reflow controller drives one - available in the online editor',
  ...
  },
  {
    ...
    description:
      'Analog carbon-monoxide sensor on an ADC pin, with a slider for the ppm in the air - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="4" width="36" height="52" rx="5" fill="#141414"/><circle cx="22" cy="12" r="5" fill="#d99c43"/><circle cx="22" cy="12" r="2.1" fill="#fff"/><circle cx="42" cy="12" r="5" fill="#d99c43"/><circle cx="42" cy="12" r="2.1" fill="#fff"/><circle cx="22" cy="48" r="5" fill="#d99c43"/><circle cx="22" cy="48" r="2.1" fill="#fff"/><circle cx="42" cy="48" r="5" fill="#d99c43"/><circle cx="42" cy="48" r="2.1" fill="#fff"/><circle cx="32" cy="30" r="14" fill="#f0885a"/><circle cx="32" cy="30" r="9" fill="#e7e7e7"/><rect x="24" y="55" width="16" height="6" rx="1" fill="#fef6d4"/></svg>',
  },
  {
    id: 'dfr-ecg-ad8232',
    label: 'Gravity: Heart Rate Monitor (ECG, AD8232)',
    description:
      'AD8232 ECG front-end whose analog output is a real PQRST waveform, at the BPM you dial in - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="16" width="56" height="32" rx="5" fill="#141414"/><circle cx="14" cy="24" r="5" fill="#d99c43"/><circle cx="14" cy="24" r="2.1" fill="#fff"/><circle cx="14" cy="40" r="5" fill="#d99c43"/><circle cx="14" cy="40" r="2.1" fill="#fff"/><rect x="2" y="28" width="18" height="8" rx="1.5" fill="#0a0a0a" stroke="#3a3a3a"/><polyline points="26,38 30,38 33,28 36,46 39,34 42,38 48,38" fill="none" stroke="#4ade80" stroke-width="2"/><rect x="52" y="24" width="7" height="16" rx="1.5" fill="#fef6d4"/></svg>',
  },
  {
    id: 'dfr-soil-moisture',
    label: 'Gravity: Capacitive Soil Moisture (IP65)',
    description:
      'Capacitive soil probe: drier soil, higher voltage, and a slider to water the pot - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="26" width="7" height="12" rx="1.5" fill="#fef6d4"/><path d="M11 32 H16" stroke="#2b2f36" stroke-width="3"/><rect x="15" y="20" width="16" height="24" rx="4" fill="#43474e" stroke="#5b616b"/><path d="M19 26 l4 4 4 -4M19 34 l4 4 4 -4" fill="none" stroke="#9aa1ab" stroke-width="2" stroke-linecap="round"/><rect x="30" y="24" width="24" height="16" rx="2" fill="#f4f5f7" stroke="#b9bec6"/><path d="M53 24 L61 32 L53 40 Z" fill="#2b2f36"/></svg>',
  },
  {
    id: 'dfr-ph-industrial',
    label: 'Gravity: Industrial Analog pH Sensor',
    description:
      'Industrial pH probe and transmitter, on the curve the DFRobot_PH library expects - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="28" width="14" height="8" rx="2" fill="#2a2e33" stroke="#4a5057"/><rect x="16" y="26" width="6" height="12" rx="1.5" fill="#a7adb5"/><rect x="22" y="10" width="40" height="44" rx="5" fill="#141414"/><circle cx="30" cy="18" r="5" fill="#d99c43"/><circle cx="30" cy="18" r="2.1" fill="#fff"/><circle cx="54" cy="18" r="5" fill="#d99c43"/><circle cx="54" cy="18" r="2.1" fill="#fff"/><circle cx="30" cy="46" r="5" fill="#d99c43"/><circle cx="30" cy="46" r="2.1" fill="#fff"/><circle cx="54" cy="46" r="5" fill="#d99c43"/><circle cx="54" cy="46" r="2.1" fill="#fff"/><path d="M42 24 c4 6 6 8 6 11 a6 6 0 0 1 -12 0 c0 -3 2 -5 6 -11 z" fill="none" stroke="#fff" stroke-width="1.6"/></svg>',
  },
  {
    id: 'dfr-c4001-mmwave',
    label: 'Gravity: C4001 24GHz mmWave Radar',
    description:
      '24GHz FMCW radar for presence and motion over I2C: walk a target in and out of its cone - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="4" width="36" height="52" rx="5" fill="#141414"/><rect x="20" y="7" width="15" height="46" rx="1.5" fill="#fce9a4"/><rect x="23" y="13" width="9" height="8" rx="1" fill="#e8c063"/><rect x="23" y="34" width="9" height="8" rx="1" fill="#e8c063"/><circle cx="42" cy="14" r="5" fill="#d99c43"/><circle cx="42" cy="14" r="2.1" fill="#fff"/><circle cx="42" cy="42" r="5" fill="#d99c43"/><circle cx="42" cy="42" r="2.1" fill="#fff"/><rect x="30" y="24" width="10" height="10" rx="1.5" fill="#2f3237"/><rect x="24" y="55" width="18" height="6" rx="1" fill="#fef6d4"/></svg>',
  },
  {
    id: 'dfr-huskylens',
    label: 'HuskyLens AI Vision Sensor',
    description:
      'The plug-and-play K210 AI camera, modelled whole: live screen, the algorithm menu, and faces and tags it learns - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="8" width="44" height="48" rx="5" fill="#101216"/><rect x="16" y="14" width="32" height="24" rx="2" fill="#05070c"/><rect x="24" y="20" width="14" height="12" fill="none" stroke="#ffd23f" stroke-width="1.5"/><circle cx="46" cy="48" r="4" fill="#05070c" stroke="#3a3f49"/></svg>',
  },
  {
    id: 'dfr-df2301q-voice',
    label: 'Gravity: DF2301Q Voice Recognition',
    description:
      'Offline speech recognition that reports command IDs over I2C - speak to it from the canvas - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="14" width="52" height="36" rx="4" fill="#0f7a4d"/><circle cx="20" cy="32" r="8" fill="#101216"/><circle cx="20" cy="32" r="3" fill="#05070c"/><rect x="34" y="22" width="20" height="6" rx="3" fill="#1d2635"/><rect x="34" y="32" width="20" height="6" rx="3" fill="#1d2635"/></svg>',
  },
  {
  ...
  },
  {
    ...
    category: 'displays',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><circle cx="32" cy="32" r="28" fill="#101114" stroke="#2c2e34" stroke-width="2"/><circle cx="32" cy="32" r="22" fill="#0b2d4f"/><circle cx="26" cy="26" r="5" fill="#2f76c4"/></svg>',
  },
  {
    id: 'grove-gesture-pag7660',
    label: 'Grove Smart IR Gesture (PAG7661QN)',
    description:
      'IR camera gesture sensor on a XIAO carrier: seat a XIAO on its socket and read rotate/tap/grab/pinch/swipe over I2C - available in the online editor',
    category: 'input',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="16" y="3" width="32" height="58" rx="5" fill="#1263a8" stroke="#0a3a66"/><circle cx="24" cy="13" r="4" fill="#3a2226"/><circle cx="40" cy="13" r="4" fill="#3a2226"/><rect x="21" y="20" width="22" height="20" rx="3" fill="#23262c" stroke="#454b56"/><circle cx="32" cy="30" r="7.5" fill="#33373f"/><circle cx="32" cy="30" r="5" fill="#0d0f13"/><circle cx="32" cy="30" r="3.4" fill="#17202f"/><circle cx="30.4" cy="28.4" r="1.3" fill="#9dbbe4"/><rect x="19" y="44" width="6" height="15" rx="1.5" fill="#15171c"/><rect x="39" y="44" width="6" height="15" rx="1.5" fill="#15171c"/><rect x="6" y="46" width="9" height="14" rx="2" fill="#eeeee9"/></svg>',
  },
  {
    id: 'respeaker-lite',
    label: 'ReSpeaker Lite (XMOS XU316)',
    description:
      'Dual-mic array with a XIAO socket: live mic in, audio out, beamforming/AEC/NS model - online editor',
    category: 'sensors',
    thumbnailSvg:
      '<svg width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="22" y="2" width="20" height="60" rx="3" fill="#16181d" stroke="#31353d" stroke-width="1"/><rect x="25" y="5" width="14" height="16" rx="2" fill="none" stroke="#3a3f4a" stroke-width="0.8" stroke-dasharray="2 1.5"/><g fill="#c8a02e"><rect x="24" y="7" width="2.6" height="2.2" rx="0.5"/><rect x="24" y="11" width="2.6" height="2.2" rx="0.5"/><rect x="24" y="15" width="2.6" height="2.2" rx="0.5"/><rect x="37.4" y="7" width="2.6" height="2.2" rx="0.5"/><rect x="37.4" y="11" width="2.6" height="2.2" rx="0.5"/><rect x="37.4" y="15" width="2.6" height="2.2" rx="0.5"/></g><path d="M32 24 L26 38 A9 9 0 0 0 38 38 Z" fill="#22c55e" fill-opacity="0.55" stroke="#7ff0b0" stroke-width="0.7"/><circle cx="25" cy="25" r="1.4" fill="#0c0d10" stroke="#4a4f59" stroke-width="0.7"/><circle cx="39" cy="25" r="1.4" fill="#0c0d10" stroke="#4a4f59" stroke-width="0.7"/><rect x="27" y="40" width="4.4" height="3.6" rx="0.8" fill="#c9c3b4"/><rect x="33" y="40" width="4.4" height="3.6" rx="0.8" fill="#c9c3b4"/><rect x="23.5" y="48" width="5" height="8" rx="1" fill="#d8963a"/><rect x="30" y="49" width="5" height="6.6" rx="0.8" fill="#e8e4d8"/><rect x="36.5" y="52" width="7" height="5" rx="2.2" fill="#aab0b8"/></svg>',
  },
];
