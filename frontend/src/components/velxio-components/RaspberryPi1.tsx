...
import boardSvg from '../../assets/Raspberry_Pi_1_illustration.svg';
import { buildPi40PinHeader } from './pi40PinHeader';

/**
 * Raspberry Pi 1 Model B+ — Velxio board art.
 *
 ...
 * really are identical; the silicon is not — BCM2835 with the RAM stacked on top and no separate Elpida package — and neither is the
...
export const RaspberryPi1 = ({ id = 'raspberry-pi-1', x = 0, y = 0 }: Props) => {
